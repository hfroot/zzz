...
- (BOOL)processPanWithLocation:(CGPoint)location deltaX:(CGFloat)deltaX deltaY:(CGFloat)deltaY isGesture:(BOOL)isGesture isDeceleration:(BOOL)isDeceleration;
- (void)handlePanStart:(CGPoint)location;
- (void)handlePanFinish;
- (void)handleZoomFinish;
- (void)handlePanEnd;
- (void)handleZoomEnd;
- (BOOL)processZoomWithDeltaX:(CGFloat)deltaX deltaY:(CGFloat)deltaY anchorX:(CGFloat)anchorX anchorY:(CGFloat)anchorY;
- (id _Nullable)handleGlobalTap:(CGPoint)location;
...
- (CGPoint)modelLocToScreenLocWithX:(double)x y:(double)y;
- (CGFloat)modelLocToScreenLocWithX:(double)x;
- (CGFloat)modelLocToScreenLocWithY:(double)y;
- (CGPoint)modelLocToContainerScreenLocWithX:(double)x y:(double)y;
- (CGFloat)modelLocToContainerScreenLocWithX:(double)x;
- (CGFloat)modelLocToContainerScreenLocWithY:(double)y;
- (CGPoint)modelLocToGlobalScreenLocWithX:(double)x y:(double)y;
- (CGFloat)modelLocToGlobalScreenLocWithX:(double)x;
- (CGFloat)modelLocToGlobalScreenLocWithY:(double)y;
- (double)scalarForScreenLocWithX:(CGFloat)x;
- (double)scalarForScreenLocWithY:(CGFloat)y;
...
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (CAShapeLayer * _Nonnull)generateLayerWithPath:(UIBezierPath * _Nonnull)path;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
+ (CGRect)frame:(CGPoint)p1 p2:(CGPoint)p2 width:(CGFloat)width;
...
- (void)onTap:(UITapGestureRecognizer * _Nonnull)sender;
- (void)didMoveToSuperview;
- (BOOL)inverted:(UIView * _Nonnull)superview;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)drawRect:(CGRect)rect;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
- (UIColor * _Nonnull)adjustBrigtnessWithFactor:(CGFloat)brightnessFactor;
@end
