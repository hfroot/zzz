...
- (CGPoint)calculatePositionWithAngle:(CGFloat)angle p:(CGPoint)p offset:(CGFloat)offset;
- (CGPoint)midPointWithRadius:(CGFloat)radius;
- (CGFloat)maxRectWidthWithCenter:(CGPoint)center height:(CGFloat)height;
